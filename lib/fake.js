...
FakeService__registerCancelList$ = (function(unitVar0)
{
    ...
    var confirmedCallback = (function(buildDescription)
    {
      ...
      if (Process__isWin$()) 
      {
        ...
        var ignored0 = Process__spawnSame$("taskkill", (("/pid " + copyOfStruct.toString()) + " /f /t"));
      }
      else
      {
        (build.Process.kill());
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _1064 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _1064;
...
Seq__Delay$BuildData_BuildData_ = (function(f)
{
    ...
    {
      var _1943;
      return Seq__Enumerator$BuildData_BuildData_(f(_1943));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _1695;
      return Seq__Enumerator$Object_Object_(f(_1695));
    }));
});

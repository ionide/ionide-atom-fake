...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _485 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _485 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _485;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _63 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _63;
    ...
    if (Process__isWin$()) 
    {
      _287 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _287 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _287;
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _1555;
      return Seq__Enumerator$Object_Object_(f(_1555));
    }));
});
